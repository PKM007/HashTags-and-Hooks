...
function Sparkles({ size = 22, className }) {
  return (
...
const NICHES = [
  {
    ...
    tagBg: "bg-cyan-950 border-cyan-800 text-cyan-300",
    bar: "bg-cyan-400",
    bonusHooks: [
      "I gave {topic} 24 hours and it broke my workflow (in the best way).",
      "Every developer needs to see this {topic} trick before 2027.",
    ],
  },
  {
    id: "fitness",
    ...
    chipActive: "bg-emerald-500 border-emerald-400 text-slate-900",
    tagBg: "bg-emerald-950 border-emerald-800 text-emerald-300",
    bar: "bg-emerald-400",
    bonusHooks: [
      "I replaced my entire routine with {topic} and my coach noticed in a week.",
      "{Topic} beats everything else I've tried for {result}. Fight me.",
    ],
  },
  {
    id: "finance",
    ...
    pain: "living paycheck to paycheck",
    ...
    chipActive: "bg-amber-500 border-amber-400 text-slate-900",
    tagBg: "bg-amber-950 border-amber-800 text-amber-300",
    bar: "bg-amber-400",
    bonusHooks: [
      "I put {topic} to the test with $1,000 — here's the ROI.",
      "Your portfolio is missing {topic} and it's costing you.",
    ],
  },
  {
    id: "vlogging",
    ...
    audience: "creators",
    result: "watch time",
    pain: "creative burnout",
    example: "a day in my life",
    power: [
      "raw",
      "unfiltered",
      "binge-worthy",
    ...
    chipActive: "bg-rose-500 border-rose-400 text-slate-900",
    tagBg: "bg-rose-950 border-rose-800 text-rose-300",
    bar: "bg-rose-400",
    bonusHooks: [
      "I filmed my entire day using only {topic}. The footage shocked me.",
      "Every vlogger needs {topic} in their kit — here's why.",
    ],
  },
  {
    id: "cooking",
    ...
    icon: "🍳",
    audience: "home cooks",
    result: "restaurant-quality meals",
    pain: "boring dinners",
    example: "15-minute dinners",
    power: [
      "mouthwatering",
      "next-level",
      "underrated",
    ...
    chipActive: "bg-orange-500 border-orange-400 text-slate-900",
    tagBg: "bg-orange-950 border-orange-800 text-orange-300",
    bar: "bg-orange-400",
    bonusHooks: [
      "I cooked {topic} every night for a week — my family begged for more.",
      "This {topic} recipe broke the internet for a reason.",
    ],
  },
  {
    id: "beauty",
    ...
    chipActive: "bg-pink-500 border-pink-400 text-slate-900",
    tagBg: "bg-pink-950 border-pink-800 text-pink-300",
    bar: "bg-pink-400",
    bonusHooks: [
      "I tested {topic} for 7 days straight — my skin barrier thanks me.",
      "Dermatologists don't want you to know this {topic} trick.",
    ],
  },
  {
    id: "travel",
    ...
    icon: "✈️",
    audience: "travelers",
    result: "unforgettable trips",
    pain: "tourist traps",
    example: "solo backpacking",
    power: [
      "underrated",
      "hidden-gem",
      "next-level",
    ...
    chipActive: "bg-sky-500 border-sky-400 text-slate-900",
    tagBg: "bg-sky-950 border-sky-800 text-sky-300",
    bar: "bg-sky-400",
    bonusHooks: [
      "I booked {topic} on a whim — best decision of the year.",
      "Skip the guidebook. {Topic} is the only travel hack you need.",
    ],
  },
  {
    id: "fashion",
    label: "Fashion",
    icon: "👗",
    audience: "style girls",
    result: "a wardrobe people ask about",
    pain: "closet clutter",
    example: "a capsule wardrobe",
    power: [
      "elevated",
      "underrated",
      "next-level",
    ...
    chipActive: "bg-fuchsia-500 border-fuchsia-400 text-slate-900",
    tagBg: "bg-fuchsia-950 border-fuchsia-800 text-fuchsia-300",
    bar: "bg-fuchsia-400",
    bonusHooks: [
      "I built a whole capsule wardrobe around {topic}. Here's the lookbook.",
      "{Topic} is the one piece every closet is missing right now.",
    ],
  },
  {
    id: "gaming",
    ...
    audience: "gamers",
    result: "clutch wins",
    pain: "getting stuck on rank",
    example: "speedrunning strategies",
    power: [
      "broken",
      "overpowered",
      "underrated",
    ...
    chipActive: "bg-violet-500 border-violet-400 text-slate-900",
    tagBg: "bg-violet-950 border-violet-800 text-violet-300",
    bar: "bg-violet-400",
    bonusHooks: [
      "I played nothing but {topic} for a week — my K/D speaks for itself.",
      "This {topic} strategy is breaking the meta right now.",
    ],
  },
  {
    id: "parenting",
    ...
    icon: "🍼",
    audience: "parents",
    result: "calmer evenings",
    pain: "meltdown bedtimes",
    example: "toddler tantrums",
    power: [
      "game-changing",
      "underrated",
      "life-saving",
    ...
    chipActive: "bg-lime-500 border-lime-400 text-slate-900",
    tagBg: "bg-lime-950 border-lime-800 text-lime-300",
    bar: "bg-lime-400",
    bonusHooks: [
      "I tried {topic} with my toddler and bedtime finally got easier.",
      "Every parent needs to hear this about {topic} before it's too late.",
    ],
  },
  {
    id: "realestate",
    ...
    chipActive: "bg-teal-500 border-teal-400 text-slate-900",
    tagBg: "bg-teal-950 border-teal-800 text-teal-300",
    bar: "bg-teal-400",
    bonusHooks: [
      "I closed a deal using {topic} — here's the exact playbook.",
      "Buyers are sleeping on {topic} and agents are cashing in.",
    ],
  },
  {
    id: "business",
    ...
    pain: "feast-or-famine months",
    example: "cold email outreach",
    power: [
      "scalable",
      "game-changing",
      "underrated",
    ...
    chipActive: "bg-indigo-500 border-indigo-400 text-slate-900",
    tagBg: "bg-indigo-950 border-indigo-800 text-indigo-300",
    bar: "bg-indigo-400",
    bonusHooks: [
      "I scaled my business with {topic} and quit my 9-to-5 in 90 days.",
      "Founders who use {topic} are outpacing everyone else right now.",
    ],
  },
  {
    id: "selfimprovement",
    ...
    chipActive: "bg-yellow-500 border-yellow-400 text-slate-900",
    tagBg: "bg-yellow-950 border-yellow-800 text-yellow-300",
    bar: "bg-yellow-400",
    bonusHooks: [
      "I changed one habit — {topic} — and my whole life shifted.",
      "This {topic} mindset shift took me from stuck to unstoppable.",
    ],
  },
  {
    id: "comedy",
    label: "Comedy",
    icon: "😂",
    audience: "your group chat",
    result: "main character energy",
    pain: "being the unfunny friend",
    example: "awkward first dates",
    power: [
      "unhinged",
      "iconic",
      "chaotic",
    ...
    chipActive: "bg-red-500 border-red-400 text-slate-900",
    tagBg: "bg-red-950 border-red-800 text-red-300",
    bar: "bg-red-400",
    bonusHooks: [
      "Tell me you've never tried {topic} without telling me 😭",
      "POV: {topic} but make it chaotic.",
    ],
  },
  {
    id: "music",
    ...
    icon: "🎵",
    audience: "producers",
    result: "a song that actually slaps",
    pain: "creative block",
    example: "lo-fi beats",
    power: [
      "fire",
    ...
    chipActive: "bg-blue-500 border-blue-400 text-slate-900",
    tagBg: "bg-blue-950 border-blue-800 text-blue-300",
    bar: "bg-blue-400",
    bonusHooks: [
      "I made a beat using only {topic} — listen to what happened.",
      "This {topic} sound is about to be everywhere on the charts.",
    ],
  },
];
...
function fillTemplate(template, niche, rawTopic) {
...
function computeScore(text, niche) {
  let score = 58;
...
function OutputCard({ id, kind, text, score, niche, copiedId, onCopy, delay }) {
  return (
    <div
...
export default function App() {
  ...
  function handleGenerate() {
    ...
    const hooks = chosenHooks.map((tpl, i) => {
      const text = fillTemplate(tpl, selectedNiche, topic);
      return {
        id: `hook-${stamp}-${i}`,
        text,
        score: computeScore(text, selectedNiche),
      };
    });
    const captions = chosenCaptions.map((tpl, i) => {
      const text = fillTemplate(tpl, selectedNiche, topic);
      return {
        id: `cap-${stamp}-${i}`,
        text,
    ...
    >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          >
            Stop the scroll.
            <br className="hidden sm:block" /> Start the algorithm.
          </h1>
          <p className="text-slate-400 max-w-xl text-sm sm:text-base">
            Pick your niche, drop a topic, and we'll forge scroll-stopping hooks
            and captions from a battle-tested copywriting framework — built for
            the way each audience actually talks.
          </p>
        </div>
        ...
        {!results && (
          <div className="mt-14 flex flex-col items-center text-center text-slate-500 py-12 border border-dashed border-slate-800 rounded-xl">
            ...
            <p className="text-sm">
              Your hooks and captions for{" "}
              <span className="text-slate-300">{selectedNiche.label}</span> will
              land here.
            </p>
          </div>
        )}
